package com.practica.appsqlite;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void saveUser(String sfullname, String semail, String spassword) {
        ...
        try {
            //crear un objeto de ContentValues parq ue contenga los mismos campos de la tabla user
            ...
            db.close();
            Toast.makeText(getApplicationContext(),"Usuario guardado exitosamnete...",Toast.LENGTH_SHORT).show();
        }
        catch (Exception e){
